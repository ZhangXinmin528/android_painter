...
import com.example.android_painter.http.utils.Convert;
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != LazyResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                LazyResponse lazyResponse = Convert.fromJson(jsonReader, type);
                response.close();
                ...
                if (code == 0) {
                    ...
                    throw new IllegalStateException("错误代码：" + code + "，错误信息：" + lazyResponse.msg);
                }
            }
        }
    }
