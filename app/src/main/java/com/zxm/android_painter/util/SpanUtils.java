 ...
 * Easy way to set {@link SpannableStringBuilder} for {@link TextView}.
 */
public final class SpanUtils {
     ...
     * @param regex
     */
    public static List<String> splitString(String origin, String regex) {
            ...
            try {
                if (origin.equals(regex)) {
                    ...
                    if (origin.contains(regex)) {
                        ...
                        final String[] arr = origin.split(regex);
     ...
     * @param regex  匹配文字
     */
    private static SpannableStringBuilder showBeautfulText(Context context, String origin, String regex) {
        if (TextUtils.isEmpty(origin) || TextUtils.isEmpty(regex)) {
            return null;
        }

        final List<String> list = splitString(origin, regex);
